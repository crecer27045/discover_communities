  ...
  <div class="login">
    <form @submit.prevent="login">
      <b-field
        ...
        :type="{
          'is-danger': errors.has('Login'),
          'is-success': fields.Login && fields.Login.valid
        }"
      ...
      <b-field
        ...
        :type="{
          ...
          'is-success': fields.Password && fields.Password.valid
        }"
...
export default {
  ...
  methods: {
    login() {
      ...
      //     if (result) {
      //       //   this.switchLoading();
      //       this.$store.dispatch(LOGIN_REQUEST, this.Form).then(() => {
